...
const Sidebar = () => {
  ...
  const adminItems = [
    ...
    { title: "Quản lý bệnh", path: "/disease", icon: <MdOutlineMedicalInformation /> },
    { title: "Hồ sơ sức khỏe", path: "/health-record", icon: <BsTextIndentLeft /> },
    { title: "Tiêm chủng", path: "/vaccination", icon: <LuSyringe /> },
    { title: "Quản lý dặn thuốc", path: "send-drug", icon: <MdMedicationLiquid /> },
  ];
  ...
  return (
    <div className={`h-screen bg-gray-100 shadow-md shadow-gray-300 border-r border-gray-200 flex flex-col transition-all duration-200 ${isCollapsed ? 'w-16' : 'w-64'}`}>
